...
import { parseSpreadsheet } from "@/lib/wahasend/spreadsheet";
import FileDropzone from "./file-dropzone";
import DataTable from "./data-table";
import { Button } from "@/components/ui/button";
import type { SendMode } from "@/lib/wahasend/types";
...
export default function StepUpload() {
  ...
  const handleRemove = () => {
    dispatch({
      ...
      data: null as unknown as import("@/lib/wahasend/types").SpreadsheetData,
    });
  };
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-text-muted mt-0.5">
              Enviar para n&uacute;meros individuais via planilha
            </p>
          </div>
        </button>
        ...
        <div className="bg-accent/5 border border-accent/20 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-text-muted mt-1">
              Voc&ecirc; ir&aacute; compor a mensagem, autenticar no WhatsApp e ent&atilde;o selecionar os grupos para envio. Vari&aacute;veis de planilha n&atilde;o est&atilde;o dispon&iacute;veis neste modo.
            </p>
          </div>
        </div>
      )}
