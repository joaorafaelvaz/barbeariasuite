...
import { detectColumnRole } from "@/lib/wahasend/spreadsheet";
import { Button } from "@/components/ui/button";
import type { ColumnMapping, ColumnRole } from "@/lib/wahasend/types";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-text-muted mt-1">
          Defina o papel de cada coluna da sua planilha. Nome e Telefone s&atilde;o obrigat&oacute;rios.
        </p>
      </div>
